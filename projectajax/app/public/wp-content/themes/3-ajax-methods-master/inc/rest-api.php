...
class WPC_REST extends WP_REST_Controller
{
  ...
  public function register_routes(){
    ...
    // route, prefix, route, ID(w/ RE)
    register_rest_route('wpc/v1', '/stores/(?P<store_id>\d+)', [
      // get the store, not create or posting, tipo di richiesta
      'methods' => WP_REST_Server::READABLE,
      // chiamiamo una callback
...
// se esiste, se non esiste la creiamo e mandiamo register route
